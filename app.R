  ...
  tags$head(
    tags$style(HTML("
      ...
      .float-in{
        ...
        animation: floatIn .75s ease-out forwards;
      }
      .float-delay-1{ animation-delay:.08s; }
      .float-delay-2{ animation-delay:.16s; }
      .float-delay-3{ animation-delay:.24s; }
      .float-delay-4{ animation-delay:.32s; }
      .float-delay-5{ animation-delay:.40s; }
    ...
    tags$script(HTML("
      ...
      function rerunFloatAnimation() {
        try {
          var activeTab = $('.tab-content .tab-pane.active');
          if (!activeTab.length) return;

          var els = activeTab.find('.float-in');
          els.each(function(){
      ...
      $(document).on('shiny:connected', function() {
        setTimeout(function(){ rerunFloatAnimation(); }, 150);
      });

      $(document).on('shown.bs.tab', 'a[data-toggle=\"tab\"]', function () {
        setTimeout(function(){ rerunFloatAnimation(); }, 50);
      });
    "))
  ),
    ...
    tabPanel(
      ...
      fluidPage(
        div(class="page-wrap",
            ...
            div(class="hero-wrap float-in",
                div(class="retro-card soft retro-pad hero-left float-delay-1",
                    ...
                    div(class="service-row",
                        div(class="retro-outline retro-pad service-item float-delay-2",
                        ...
                        div(class="retro-outline retro-pad service-item float-delay-3",
                        ...
                        div(class="retro-outline retro-pad service-item float-delay-4",
                ...
                div(class="hero-right float-in float-delay-2",
                    div(class="hero-img",
                        tags$img(
            ...
            div(class="retro-card soft retro-pad float-in float-delay-3",
            ...
            div(class="retro-card retro-pad float-in float-delay-4",
    ...
    tabPanel(
      ...
      fluidPage(
        div(class="page-wrap",
            ...
            div(class="retro-card soft retro-pad float-in",
                h2(style="margin:0; font-weight:1000;", "Ringkasan Materi Central Limit Theorem")
            ),
            
            tags$div(style="height:12px;"),
            
            div(class="retro-card retro-pad float-in float-delay-1",
            ...
            div(class="retro-card retro-pad float-in float-delay-2",
            ...
            div(class="retro-card retro-pad float-in float-delay-3",
            ...
            fluidRow(
              ...
              column(
                6,
                div(class="retro-card retro-pad float-in float-delay-5",
                    ...
                    tags$table(
                      ...
                      tags$tbody(
                        tags$tr(tags$td(tags$b("X\u0304")), tags$td("Rata-rata sampel"), tags$td("Nilai rata-rata yang dihitung dari data sampel.")),
                    ...
                    p(style="margin-top:10px; margin-bottom:0; font-size:13px; opacity:0.9;",
                      strong("Intinya: "), "X\u0304 ~ N(\u03BC, \u03C3\u00B2/n) ketika n cukup besar."
                    )
                )
              )
            )
    ...
    tabPanel(
      ...
      fluidPage(
        div(class="page-wrap",
            ...
            fluidRow(
              column(4,
                     div(class="retro-card retro-pad team-card float-in float-delay-1",
              ...
              column(4,
                     div(class="retro-card retro-pad team-card float-in float-delay-2",
              ...
              column(4,
                     div(class="retro-card retro-pad team-card float-in float-delay-3",
            ...
            br(),
            div(class="retro-card soft retro-pad float-in float-delay-4", style="text-align:center;",
...
server <- function(input, output, session) {
  ...
  observeEvent(input$upload_to_dist, {
    removeModal()
    updateNavbarPage(session, "main_nav", selected = "Distribusi Awal")
    send_highlight("file_data2", duration = 2600, shake = TRUE)
  })
  
  observeEvent(input$upload_to_sim, {
    removeModal()
    updateNavbarPage(session, "main_nav", selected = "Simulasi CLT")
